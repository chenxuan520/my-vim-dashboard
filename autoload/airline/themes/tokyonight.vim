...
let s:airline_mode_normal         = [ s:background[0], s:green[0],            s:background[1], s:green[1]            ]
let s:airline_mode_insert         = [ s:background[0], s:blue[0],             s:background[1], s:blue[1]             ]
let s:airline_mode_replace        = [ s:background[0], s:yellow[0],           s:background[1], s:yellow[1]           ]
let s:airline_mode_visual         = [ s:background[0], s:red[0],              s:background[1], s:red[1]              ]
